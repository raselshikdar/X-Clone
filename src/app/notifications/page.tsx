          ...
          <SheetContent className="w-[300px] sm:w-[350px]">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-base font-bold">Notify me about</h3>

                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-[15px] font-normal">Likes</Label>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <Label className="text-[15px] font-normal">Reposts</Label>
                    <Switch
                      checked={settings.retweets}
                      onCheckedChange={(checked) => updateSetting("retweets", checked)}
                      disabled={isLoading || !settings.notificationsEnabled}
                    />
                  </div>

                  <div className="flex items-center justify-between">
                    <Label className="text-[15px] font-normal">New followers</Label>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <Label className="text-[15px] font-normal">Mentions</Label>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <Label className="text-[15px] font-normal">Quote posts</Label>
                    <Switch
                      checked={settings.quotes}
                      onCheckedChange={(checked) => updateSetting("quotes", checked)}
                      disabled={isLoading || !settings.notificationsEnabled}
                    />
                  </div>
                </div>
